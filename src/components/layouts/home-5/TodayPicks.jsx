                            ...
                            data.slice(0,visible).map((item,index) => (
                                <div key={index} className="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                    <div className='sc-card-product'>
                                        <div className={`card-media  ${item.feature ? 'comingsoon' : '' } `}>
                                        ...
                                        <div className="card-bottom">
                                            <button onClick={() => setModalShow(true)} className="sc-button style rocket fl-button pri-3 no-bg"><span>Join</span></button>
