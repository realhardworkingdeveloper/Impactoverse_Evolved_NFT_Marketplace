...
const TodayPicks = () => {
    ...
    return (
        <Fragment>
                                            ...
                                            <TabPanel key={data.id}>
                                                {
                                                    ...
                                                    <div key={item.id} className='sc-card-product explode style2 mg-bt explore-item' onClick={() => setModalShow(true)}>                               
            ...
            <GalleryDetail className="gallery-modal"
                show={modalShow}
